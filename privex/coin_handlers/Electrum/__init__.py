...
**Coin object settings**:
    ...
    =============   ==================================================================================================
    coin_type       This should be set to ``Electrumd RPC compatible crypto`` (db value: bitcoind)
...
from privex.coin_handlers.Electrum.ElectrumLoader import ElectrumLoader
from privex.coin_handlers.Electrum.ElectrumManager import ElectrumManager
# from django.conf import settings

from privex.coin_handlers.Electrum.ElectrumMixin import ElectrumMixin
...
COIN_TYPE = 'electrum'
HANDLER_DESC = 'Electrum RPC compatible crypto'
...
def reload():
    ...
    By default, as there are many coins that use a direct fork of electrum, our classes can provide for any
    :class:`models.Coin` by scanning for coins with the type ``electrum``. This saves us from hard coding
